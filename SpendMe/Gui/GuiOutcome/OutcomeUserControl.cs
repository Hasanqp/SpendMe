...
namespace SpendMe.Gui.GuiOutcome
{
    public partial class OutcomeUserControl : UserControl
    {
                        ...
                        for (int i = 0; i < IdList.Count; i++)
                        {
                            ...
                            if (result == 1)
                            {
                                ...
                                SystemRecords systemRecords = new SystemRecords
                                {
                                    ...
                                    Details = "Процесс траты по номеру был удален" + RowId.ToString(),
        ...
        private void SetColumnsTitle()
        {
            ...
            dataGridView1.Columns[3].HeaderText = "История трята";
        ...
        private DataTable SetDataTableColumns(DataTable dataTable)
        {
            ...
            dataTable.Columns["SupplierName"].ColumnName = "Поставщик";
            dataTable.Columns["OutcomeDate"].SetOrdinal(3);
            dataTable.Columns["OutcomeDate"].ColumnName = "История тратия";
