...
namespace SpendMe.Gui.GuiSystemRecords
{
    public partial class RecordsUserControl : UserControl
    {
        ...
        private static RecordsUserControl _CategoryUserControl;
        private int RowId;
        ...
        {
            return _CategoryUserControl ?? (new RecordsUserControl());
        }
        ...
        private void SetColumnsTitle()
        {
            ...
            dataGridView1.Columns[4].HeaderText = "Время добавления";
        }
        ...
        private DataTable SetDataTableColumns(DataTable dataTable)
        {
            ...
            dataTable.Columns["Title"].ColumnName = "Адрес";
